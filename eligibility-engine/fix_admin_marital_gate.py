              ...
              <div>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1rem 1rem 0.65rem 1rem" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    ...
                    <div>
                      <span style={{ fontSize: "0.75rem", fontWeight: 700, color: "var(--text-primary)", display: "block" }}>Marital Age Relaxation</span>
                      <span style={{ fontSize: "0.55rem", fontWeight: 600, color: "var(--text-tertiary)" }}>Standard: Unmarried & Married Included</span>
                    </div>
                  </div>
                      ...
                      <div style={{ padding: "0.75rem" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "8px", background: "white", padding: "4px 10px", borderRadius: "8px", border: "1px solid var(--border-subtle)" }}>
                            ...
                            <input type="number" style={{ width: "28px", background: "transparent", border: "none", fontSize: "0.85rem", fontWeight: 800, padding: 0, textAlign: "right", color: "var(--accent-primary)", outline: "none" }} value={activeExam.marital_grace_period ?? 5} onChange={(e) => updateExamData((p) => ({ ...p, marital_grace_period: Number(e.target.value) }))} />
...
if re.search(pattern, text):
    ...
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(new_text)
    print("Successfully replaced renderAgeLimits with Intelligent Gate UI")
else:
    print("Error: Could not find function pattern in Admin.jsx")
